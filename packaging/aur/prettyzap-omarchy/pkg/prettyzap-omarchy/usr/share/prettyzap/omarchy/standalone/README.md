...
offers Open / Hide, Settings, and the WhatsApp/System theme toggle from a small
popup. It needs only Quickshell — **not** Omarchy's `qs.Ui` kit — so it works on
...
- **Right-click** — popup with Open / Hide, Settings, and Theme buttons.
